...
const I18N_CONF = {
  ...
  MainLayout: {
    ...
    userAppPermissionsManagement: 'User App Permission Management',
  },
  Password: {
  ...
  UserAppPermissionsManagement: {
    privilegeManagement: 'User App Permissions Management',
    addAppPermission: 'Add App Permission',
    username: 'Username',
    app: 'Application',
    action: 'Action',
    module: 'Module',
    ...
    appPlaceholder: 'Please select app',
  },
  NewUserAppPermissions: {
    ...
    appError: 'App cannot be empty!',
    moduleError: 'Module cannot be empty!',
    actionError: 'Action cannot be empty!',
    readOnly: 'read only',
    writeOnly: 'write only',
    readWrite: 'Read and write',
  ...
  EditUserAppPermission: {
    editAppPermission: 'Edit App Permission',
    username: 'Username',
    app: 'App',
    action: 'Action',
    module: 'Module',
